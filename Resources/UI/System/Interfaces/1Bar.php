<?php include root.'Resources/UI/'.Registry::fetch('Interface')->ui.'/Style/Colorsheet.php'; ?>
<html>
<head>
	<?php Registry::fetch('Interface')->js_include(path(true).'Scripts/html_notifications.js'); ?>
...
<body><!--[if IE]><center><![endif]-->
	...
	<?php	
	if(Registry::fetch('Interface')->notification_count(UIError) > 0) Registry::fetch('Interface')->notification(UIError);
	if(Registry::fetch('Interface')->notification_count(UINotice) > 0) Registry::fetch('Interface')->notification(UINotice);
	?>
